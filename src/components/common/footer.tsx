...
const Footer: React.FC<FooterProps> = ({}) => {
  ...
  return (
    <footer className=" sticky bottom-0 flex justify-between items-center bg-neutral-950 p-4 max-[1200px]:py-6">
      <div className="flex items-center gap-4 max-[1200px]:gap-2">
        <div className="relative group">
          ...
          <NextImage
            ...
            alt=""
            width={42}
            className="group-hover:opacity-50 max-[1200px]:w-[34px] max-[1200px]:h-[34px]"
            height={42}
          />
        </div>
        <div className="flex flex-col gap-[-2px]">
          <h1 className="text-sm font-bold max-[1200px]:text-xs cursor-pointer hover:underline ">
            Só existe o agora
          </h1>
          <span className="text-xs font-bold max-[1200px]:text-xs cursor-pointer hover:underline hover:text-neutral-300 text-neutral-500">
            Charlie Brown Jr.
          </span>
        </div>
      ...
      <div className="flex justify-center  items-center flex-col gap-1 max-[1200px]:hidden">
      ...
      <div className="flex gap-4 items-center max-[1200px]:hidden">
