...
const Footer: React.FC<FooterProps> = ({}) => {
  ...
  return (
    <footer className="flex justify-between items-center bg-neutral-950 p-4">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-[-2px]">
          ...
          <span className="text-xs font-bold hover:underline hover:text-neutral-300 text-neutral-500">
            Charlie Brown Jr.
          </span>
        </div>
      ...
      <div className="flex justif] items-center flex-col gap-4">
        <div className="flex items-center gap-6">
          ...
          />
          <button
            className="group bg-white w-[40px] h-[40px] rounded-full flex justify-center items-center"
            onClick={togglePlay}
          >
            {play === true ? (
              <Play className="text-neutral-800 group-hover:text-neutral-950" />
            ) : (
              <Pause className="text-neutral-800 group-hover:text-neutral-950" />
            )}
          </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="bg-zinc-600 h-1 rounded-full w-96">
